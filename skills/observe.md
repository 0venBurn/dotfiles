...
Read everything in `docs/` first. Then:

- Identify gaps — what's undocumented or out of date?
- Add **only new information** — do not rewrite or restructure existing content
- Place findings in the most relevant existing doc; create a new doc only if no suitable one exists
